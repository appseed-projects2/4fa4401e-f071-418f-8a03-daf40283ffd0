...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-15 19:07`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/4fa4401e-f071-418f-8a03-daf40283ffd0.git
$ cd 4fa4401e-f071-418f-8a03-daf40283ffd0
```
